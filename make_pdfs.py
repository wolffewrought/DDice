...
('code', [('/fight start players:@a @b npcs:Goblin, Orc', 'any number of each', 'player'),
          ...
          ('(the buttons)', 'on your turn: five stat buttons to attack with, then\nGrapple \u00b7 Feint \u00b7 Deflect \u00b7 Disarm beneath. Holding someone\nadds Maintain the hold / Release; being held adds Break free.\nSave and Insight appear on the card that asks for them'),
